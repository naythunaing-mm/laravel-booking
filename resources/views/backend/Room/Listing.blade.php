                          ...
                          <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <a href="{{ URL::to('admin-backend/room/room-gallery/edit/') }}" class="btn btn-success btn-xs"><small><i class="fa fa-photo"> Gallery</i></small></a>
                                      <a href="{{ URL::to('admin-backend/room/room-gallery/edit/') }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"> View</i></a>
